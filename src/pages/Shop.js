...
export default function Shop() {
    ...
    const addToCart = (title, price, imgSrc) => {
        ...
        console.log(cartRow)
        cartRow.getElementsByClassName('btn-danger')[0].addEventListener('click', handleRemove)
                    ...
                    {items.map(item => (
                        <div className='shop-item' key={item.itemId}>
                            ...
                            <div className='shop-item-details'>
                                ...
                                <button className='btn btn-primary shop-item-button' type='button' onClick={clickCart}>ADD TO CART</button>
                            </div>
                        </div>
                    ))}
                </div>
